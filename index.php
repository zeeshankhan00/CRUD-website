...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="snoEdit"  id = "snoEdit">
            <div class="mb-3">
              <label for="title" class="form-label">Note Record</label>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
     ...
     <strong>Success!</strong> Your informations have been saved successfully.
...
?>
     ...
     <strong>Success!</strong> Your informations have been updated successfully.
     <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   </div>';
...
?>
     ...
     <strong>Success!</strong> Your informations have been deleted successfully.
     <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   </div>';
...
<!-- Form -->
        ...
        <form action = "http://localhost/php/CRUD/index.php" method = "post">
            ...
            <div class="mb-3">
              <label for="decription" class="form-label">Note Description</label>
              <div class="form-floating">
                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="desc"></textarea>
